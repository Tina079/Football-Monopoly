...
const PAGES = [
  {
    ...
    content: (
      <>
        ...
        <h4>🗺️ 棋盘</h4>
        <ul>
          <li>40 格环形棋盘，包含 <strong>23 座球场</strong>、4 个赞助商、银行、监狱、机场、转会窗、训练营、青训学院、街头足球、随机事件等。</li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h4>⚽ 球员系统</h4>
        <ul>
          <li>86 名球员可供获取：街头足球（半价购买 32 人）、转会窗竞拍（16 人）、青训学院盲盒（15 人，5kw）、球场升至 Lv3 自动获得驻守球员（23 人）。</li>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>每轮比拼后，参赛球员在对应属性维度获得 <strong>+1 成长</strong>，胜方获得 <strong>+1 训练点</strong>。</li>
        </ul>
        <h4>📊 联赛积分</h4>
        <ul>
